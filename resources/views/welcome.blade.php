...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5">Surat Keterangan Lulus (SKL)</h1>
    <p class="lead">Download Surat Keterangan Lulus (SKL) SMK Negeri 1 Krangkeng secara Online</p>
  </div>
</main>

<footer class="footer mt-auto py-3 bg-body-tertiary">
  <div class="container">
    <span class="text-body-secondary">Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})</span>
  </div>
</footer>
<script data-navigate-once src="{{ asset('assets/dist/js/bootstrap.bundle.min.js') }}"></script>
